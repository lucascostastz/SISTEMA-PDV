...
class Ui_Ui_Edit_Produto(object):
    def setupUi(self, Ui_Edit_Produto):
        Ui_Edit_Produto.setObjectName("Ui_Edit_Produto")
        Ui_Edit_Produto.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        Ui_Edit_Produto.resize(985, 610)
        Ui_Edit_Produto.setMinimumSize(QtCore.QSize(985, 610))
        Ui_Edit_Produto.setMaximumSize(QtCore.QSize(985, 630))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./img/produtos-.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Ui_Edit_Produto.setWindowIcon(icon)
        Ui_Edit_Produto.setStyleSheet("")
        self.fr_FormProdutos = QtWidgets.QFrame(parent=Ui_Edit_Produto)
...
"}")
        ...
        self.lb_FormProdutos_15.setGeometry(QtCore.QRect(760, 510, 150, 20))
...
"}")
        ...
        self.lb_FormProdutos_16.setGeometry(QtCore.QRect(460, 510, 150, 20))
...
"}")
        ...
        self.Tx_Data_Cadastro.setGeometry(QtCore.QRect(490, 530, 181, 25))
...
"}")
        ...
        self.Tx_Validade.setGeometry(QtCore.QRect(790, 530, 161, 25))
...
"}")
        ...
        self.label_10.setGeometry(QtCore.QRect(460, 530, 31, 25))
        self.label_10.setStyleSheet("background-color: rgb(0, 170, 127);")
        self.label_10.setText("")
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(parent=self.fr_FormProdutos)
        self.label_11.setGeometry(QtCore.QRect(760, 530, 31, 25))
        self.label_11.setStyleSheet("background-color: rgb(0, 170, 127);")
        ...
        self.retranslateUi(Ui_Edit_Produto)
        QtCore.QMetaObject.connectSlotsByName(Ui_Edit_Produto)
        Ui_Edit_Produto.setTabOrder(self.tx_DescricaoProduto, self.cb_CategoriaProduto)
        Ui_Edit_Produto.setTabOrder(self.cb_CategoriaProduto, self.tx_Marca)
        Ui_Edit_Produto.setTabOrder(self.tx_Marca, self.tx_Estoque)
        Ui_Edit_Produto.setTabOrder(self.tx_Estoque, self.tx_Codigo)
        Ui_Edit_Produto.setTabOrder(self.tx_Codigo, self.tx_Preco_Produto)
        Ui_Edit_Produto.setTabOrder(self.tx_Preco_Produto, self.tx_Venda_Varejo)
        Ui_Edit_Produto.setTabOrder(self.tx_Venda_Varejo, self.tx_Venda_Atacado)
        Ui_Edit_Produto.setTabOrder(self.tx_Venda_Atacado, self.tx_MinimoAtacado)
        Ui_Edit_Produto.setTabOrder(self.tx_MinimoAtacado, self.bt_AddImagem)

    def retranslateUi(self, Ui_Edit_Produto):
        _translate = QtCore.QCoreApplication.translate
        Ui_Edit_Produto.setWindowTitle(_translate("Ui_Edit_Produto", "CADASTRO PRODUTOS"))
        self.lb_FormProdutos.setText(_translate("Ui_Edit_Produto", "CADASTRAR PRODUTO"))
        self.lb_FotoProduto.setToolTip(_translate("Ui_Edit_Produto", "Insira uma imagem"))
        self.lb_FormProdutos_2.setText(_translate("Ui_Edit_Produto", "DESCRIÇÃO"))
        self.tx_DescricaoProduto.setPlaceholderText(_translate("Ui_Edit_Produto", "DESCRIÇÃO DO PRODUTO"))
        self.lb_FormProdutos_3.setText(_translate("Ui_Edit_Produto", "CATEGORIA"))
        self.cb_CategoriaProduto.setItemText(0, _translate("Ui_Edit_Produto", "SELECIONE"))
        self.cb_CategoriaProduto.setItemText(1, _translate("Ui_Edit_Produto", "OUTROS"))
        self.cb_CategoriaProduto.setItemText(2, _translate("Ui_Edit_Produto", "ALIMENTOS "))
        self.cb_CategoriaProduto.setItemText(3, _translate("Ui_Edit_Produto", "BEBIDAS"))
        self.cb_CategoriaProduto.setItemText(4, _translate("Ui_Edit_Produto", "INFORMÁTICA"))
        self.cb_CategoriaProduto.setItemText(5, _translate("Ui_Edit_Produto", "ELETRÔNICOS"))
        self.lb_FormProdutos_4.setText(_translate("Ui_Edit_Produto", "MARCA"))
        self.lb_FormProdutos_5.setText(_translate("Ui_Edit_Produto", "ESTOQUE"))
        self.lb_FormProdutos_6.setText(_translate("Ui_Edit_Produto", "CÓDIGO"))
        self.lb_FormProdutos_8.setText(_translate("Ui_Edit_Produto", "PREÇOS"))
        self.tx_Preco_Produto.setPlaceholderText(_translate("Ui_Edit_Produto", "R$ 0.00"))
        self.lb_FormProdutos_10.setText(_translate("Ui_Edit_Produto", "PREÇO"))
        self.tx_Venda_Varejo.setPlaceholderText(_translate("Ui_Edit_Produto", "R$ 0.00"))
        self.lb_FormProdutos_12.setText(_translate("Ui_Edit_Produto", "VENDA VAREJO"))
        self.lb_FormProdutos_13.setText(_translate("Ui_Edit_Produto", "VENDA ATACADO"))
        self.tx_Venda_Atacado.setPlaceholderText(_translate("Ui_Edit_Produto", "R$ 0.00"))
        self.lb_FormProdutos_14.setText(_translate("Ui_Edit_Produto", "QTDE. MÍNIMA P/ ATACADO"))
        self.tx_Marca.setPlaceholderText(_translate("Ui_Edit_Produto", "NOVA MARCA"))
        self.bt_AddImagem.setToolTip(_translate("Ui_Edit_Produto", "<html><head/><body><p>CADASTRAR IMGEM</p></body></html>"))
        self.bt_AddImagem.setText(_translate("Ui_Edit_Produto", "Inserir Imagem"))
        self.Bt_SalvarProdutos.setText(_translate("Ui_Edit_Produto", "SALVAR"))
        self.Bt_CancelarProdutos.setText(_translate("Ui_Edit_Produto", "CANCELAR"))
        self.lb_FormProdutos_15.setText(_translate("Ui_Edit_Produto", "VALIDADE"))
        self.lb_FormProdutos_16.setText(_translate("Ui_Edit_Produto", "DATA CADASTRO"))
        self.Tx_Data_Cadastro.setPlaceholderText(_translate("Ui_Edit_Produto", "eX: 01/01/2000"))
        self.Tx_Validade.setPlaceholderText(_translate("Ui_Edit_Produto", "eX: 01/01/2025"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Ui_Edit_Produto = QtWidgets.QFrame()
    ui = Ui_Ui_Edit_Produto()
    ui.setupUi(Ui_Edit_Produto)
    Ui_Edit_Produto.show()
    sys.exit(app.exec())
