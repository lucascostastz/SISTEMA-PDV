...
"}")
        ...
        Form_Cad_Clientes.setTabOrder(self.tx_rg, self.tx_Credito)
        Form_Cad_Clientes.setTabOrder(self.tx_Credito, self.tx_Telefone)
        Form_Cad_Clientes.setTabOrder(self.tx_Telefone, self.tx_Email)
        Form_Cad_Clientes.setTabOrder(self.tx_Email, self.tx_Cep)
        Form_Cad_Clientes.setTabOrder(self.tx_Cep, self.tx_Endereco)
