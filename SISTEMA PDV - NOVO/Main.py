...
######## --- Chama Telas --- ########
        ...
        self.edit_produto.bt_Update_Img.clicked.connect(self.editar_img_produto)
...
######## --- Chama StakeWidgets --- ########
    ...
    def atualizar_valor_total(self):
        ...
        for row in range(self.inicio.TableWidget_Venda.rowCount()):
            ...
            self.inicio.label_total.setText(str(self.total))
        self.focus_codigo()
        

    def abrir_finaliza_venda(self):
        try:
            self.jan_fecha_venda.Lb_TotalPagar.setText(str(f'{self.total:.2f}'))
...
######## --- Funções chamada de telas --- ########
    ...
    def chama_edit_produto(self):
        ...
        self.edit_produto.tx_AddCategoria.setText(str(produto[0][2]))
        self.edit_produto.tx_AddMarca.setText(str(produto[0][3]))
        self.edit_produto.tx_EstoqueMinimoProduto.setText(str(produto[0][4]))
        self.edit_produto.tx_Codigo.setText(str(produto[0][5]))
        self.edit_produto.tx_Preco.setText(str(produto[0][6]))
        self.edit_produto.tx_ValorVarejoProduto.setText(str(produto[0][7]))
        self.edit_produto.tx_ValorAtacadoProduto.setText(str(produto[0][8]))
        self.edit_produto.tx_MinimoAtacado.setText(str(produto[0][9]))
        self.edit_produto.lb_FotoProduto.setPixmap(QPixmap(str(produto[0][10])))
        self.banco.query.commit()
        self.banco.query.close()
    ...
    def chama_edit_cliente(self):
        ...
        self.edit_cliente.tx_Rg.setText(str(produto[0][2]))
        self.edit_cliente.tx_Cpf.setText(str(produto[0][3]))
    ...
    def salvar_cliente_editado(self):
        # Valor digitado no lineEdit
            ...
            # Atualizar os dados no banco  
            self.banco.cursorr.execute("UPDATE pdv.clientes SET nome = '{}', rg  = '{}', cpf = '{}', telefone ='{}', email = '{}', cep = '{}', endereco = '{}', numero = '{}', bairro = '{}', cidade = '{}', estado = '{}'  WHERE idclientes = {}".format(
                nome, rg, cpf, telefone, email, cep, endereco, numero, bairro, cidade, estado ,self.valor_id_editcliente))
            self.banco.query.commit()
            self.banco.query.close()
            self.listar_clientes()
...
######## --- Funções Inserir itens --- ########    
    ...
    def inserir_clientes(self):
        ...
        self.banco.conectar()
        self.banco.cursorr.execute("INSERT INTO pdv.clientes (nome,rg,cpf,telefone,email,cep,endereco,numero,bairro,cidade,estado) VALUES('" +
...
######## --- Funções Listar listar Itens --- ######## 
    ...
    def listar_clientes(self):
        ...
        self.inicio.TableWidget_Cliente.setColumnWidth(7,145)
        self.inicio.TableWidget_Cliente.setColumnWidth(8,60)
        self.inicio.TableWidget_Cliente.setColumnWidth(9,200)
        self.inicio.TableWidget_Cliente.setColumnWidth(10,100)
        self.inicio.TableWidget_Cliente.setColumnWidth(10,100)
        ...
        self.inicio.TableWidget_Cliente.setColumnCount(12)
