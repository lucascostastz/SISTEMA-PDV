...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        # Limpa o layout atual ou adiciona um novo layout
        ...
        self.layout().addWidget(self.frame_principal)

        # Adiciona um botão fora do frame principal que chama init_ui
        button_reload = QPushButton('Recarregar', self)
        button_reload.clicked.connect(self.init_ui)
        self.layout().addWidget(button_reload)
